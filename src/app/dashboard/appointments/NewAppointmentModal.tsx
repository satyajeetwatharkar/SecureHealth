...
export default function NewAppointmentModal({ patients, doctors }: { patients: UserBasic[], doctors: UserBasic[] }) {
                                    ...
                                    <div className="mt-3 w-full text-center sm:mt-0 sm:text-left">
                                        ...
                                        <div className="mt-4 space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <select id="doctorId" name="doctorId" required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border">
                                            ...
                                            <div>
                                                ...
                                                <input type="datetime-local" name="date" id="date" required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border" />
                                                <button type="button" className="mt-2 inline-flex items-center rounded-md bg-white px-2.5 py-1.5 text-xs font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 mb-2">
                                                    <svg className="h-3 w-3 mr-1 text-emerald-500" viewBox="0 0 20 20" fill="currentColor">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="reason" id="reason" required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border" placeholder="e.g., Annual Checkup" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
